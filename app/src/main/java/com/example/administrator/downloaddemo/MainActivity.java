    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_pauseDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.stopDownload(MainActivity.this, mHandler, Constant.downloadUrl, filename,
                        1);
            }
        });
        btn_startDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.startDownload(MainActivity.this, mHandler, Constant.downloadUrl,
                        filename, 1);
            }
        });
    }
